    ...
    public class TwoHandManipulatable : MonoBehaviour, IInputHandler, ISourceStateHandler
    {
        ...
        void ManipulationModeUpdate()
        {
            if (CurrentMode!=MainPlayer.GetComponent<PlayerState>().ManipulationMode)
            {
                ...
                {
                    SetManipulationMode(TwoHandedManipulation.Rotate);
                ...
                {
                    SetManipulationMode(TwoHandedManipulation.Scale);
                    m_rotateLogic = new TwoHandRotateLogic(AxisConstraint.None);
                }
                else if (CurrentMode == "MoveRotateScale")
                {
                    SetManipulationMode(TwoHandedManipulation.MoveRotateScale);
                    m_rotateLogic = new TwoHandRotateLogic(AxisConstraint.None);
                }
            }
        }
